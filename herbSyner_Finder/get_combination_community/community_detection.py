...
class Herb_Comb_Community:
    ...
    def _filter_admet(self, subset_data_I,ADMET, ADMET_filter):
    ...
    def _get_optimal_distance_threshold(self):
        ...
        # 生成序列
        distance_threshold_list = list(np.arange(start+0.1, end + 0.1, 0.1))
        ...
        for distance_threshold in tqdm.tqdm(distance_threshold_list):
            ...
            if Q_value > max_Q:
                max_Q = Q_value
                max_distance_thresh = distance_threshold
        ...
        if default_distance_thresh != None:
            ...
            print('The Q of all distance cut is less than 0.3 which is not ideal community. We select the distance cut with max Q = {} at distance cut of {}'.\
                format(max_Q, max_distance_thresh))
            return max_Q, max_distance_thresh
    ...
    def get_herb_communities(self, ADMET_filter = False):
        ...
        subset_data_I_ADMET = self._filter_admet(subset_data_I,ADMET,ADMET_filter) 
